import { Search, Filter, MapPin, Clock, Users, Video, Home, Calendar } from "lucide-react";
  ...
  const studyGroups = [
    {
      ...
      description: "Focus on SQL queries and database design. We meet twice a week and work on practice problems together.",
      avatars: ["JD", "SK", "MT", "AL", "RC"]
    },
    {
      id: 2,
      name: "Calculus Conquerors",
      course: "Calculus II",
      courseCode: "MATH 2345",
      schedule: "M/W/F 5PM",
      members: 12,
      maxMembers: 15,
      type: "Virtual",
      studyStyle: "Visual",
      location: "Zoom",
      description: "Interactive problem-solving sessions with whiteboard explanations. Great for visual learners!",
      avatars: ["DW", "KL", "NP", "BH"]
    },
    {
      id: 3,
      ...
      maxMembers: 10,
      type: "In-Person",
      studyStyle: "Practice-focused",
      location: "Engineering Building 102",
      description: "Work through difficult physics problems together. Bring your homework questions!",
      avatars: ["TY", "HG", "QZ", "LM"]
    },
    {
      id: 4,
      ...
      description: "Code together, review algorithms, and prepare for exams. All skill levels welcome!",
      avatars: ["MW", "JK", "FP", "VS"]
    },
    {
      id: 5,
      name: "Chemistry Lab Group",
      course: "Chemistry I Lab",
      courseCode: "CHEM 1211L",
      schedule: "Th 2PM",
      members: 4,
      maxMembers: 6,
      type: "In-Person",
      ...
      description: "Pre-lab prep and post-lab analysis. Help each other understand lab reports.",
      avatars: ["RB", "CN", "DP"]
    },
    {
      id: 6,
      name: "English Lit Discussion",
      ...
      location: "Discord",
      description: "Deep dive into course readings and prepare for essays together.",
      avatars: ["SM", "TL", "KR", "AW"]
    }
  ];
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-4 gap-2">
                          {['M', 'T', 'W', 'Th', 'F', 'Sa', 'Su'].map((day) => (
                            <Button key={day} variant="outline" size="sm" className="rounded-lg">
                              {day}
                            </Button>
                          ))}
                        </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <Badge className={
                            group.type === 'Virtual' ? 'bg-blue-500' :
                            group.type === 'In-Person' ? 'bg-green-500' :
                            'bg-purple-500'
                          }>
                            {group.type === 'Virtual' ? <Video className="h-3 w-3 mr-1" /> :
                             group.type === 'In-Person' ? <Home className="h-3 w-3 mr-1" /> :
                    ...
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-xs text-muted-foreground">
                        +{group.members - group.avatars.length} more
                      </span>
                    </div>

                    {/* Actions */}
                    <div className="flex gap-2">
                      <Button className="flex-1 rounded-xl gradient-gold gradient-gold-hover shadow-md">
                        Join Group
                      </Button>
