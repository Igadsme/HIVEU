import { Calendar, Clock, Plus, BookOpen, MessageSquare, Users, TrendingUp, Award, Sparkles, Brain, Target, Zap, FileText, GraduationCap } from "lucide-react";
  ...
  const smartMatches = [
    {
      ...
      coursesOverlap: 85,
      compatibility: 95,
      sharedCourses: ["CS 3410", "MATH 2345"]
    },
    {
      id: 2,
      name: "David Kim",
      ...
      <div className="container mx-auto p-4 md:p-6 lg:p-8 space-y-6">
        ...
        >
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {/* HiveMind AI */}
            <Card 
              className="rounded-2xl bg-gradient-to-br from-blue-500/10 to-background border-2 border-blue-500/20 hover:shadow-xl transition-all cursor-pointer hover:scale-[1.02]"
              onClick={() => onNavigate('hivemind')}
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="font-semibold">HiveMind AI</h4>
                    <p className="text-xs text-muted-foreground">Study Assistant</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">Get instant help with homework and explanations</p>
              </CardContent>
            </Card>

            {/* Tutors */}
            <Card 
              className="rounded-2xl bg-gradient-to-br from-green-500/10 to-background border-2 border-green-500/20 hover:shadow-xl transition-all cursor-pointer hover:scale-[1.02]"
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="font-semibold">Peer Tutors</h4>
                    <p className="text-xs text-muted-foreground">1-on-1 Help</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">Book sessions with top student tutors</p>
              </CardContent>
            </Card>

            {/* Study Vault */}
            <Card 
              className="rounded-2xl bg-gradient-to-br from-purple-500/10 to-background border-2 border-purple-500/20 hover:shadow-xl transition-all cursor-pointer hover:scale-[1.02]"
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="font-semibold">Study Vault</h4>
                    <p className="text-xs text-muted-foreground">Materials Library</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">Access shared notes and resources</p>
              </CardContent>
            </Card>

            {/* HivePoints */}
            <Card 
              className="rounded-2xl bg-gradient-to-br from-primary/15 to-background border-2 border-primary/30 hover:shadow-xl transition-all cursor-pointer hover:scale-[1.02]"
              onClick={() => onNavigate('hivepoints')}
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <h4 className="font-semibold">HivePoints</h4>
                    <p className="text-xs text-muted-foreground">Level 8 • 2,340 pts</p>
                  </div>
                </div>
                <p className="text-sm text-muted-foreground">Earn rewards and unlock perks</p>
              </CardContent>
            </Card>
          </div>
        </motion.div>
